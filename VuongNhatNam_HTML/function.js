window.onload = function onLoad() {  
    ...
    var dbRef = firebase.database().ref().child('HCM/TEMP');
    var dbRef2 = firebase.database().ref().child('HCM/HUMI');
    var dbRef3 = firebase.database().ref().child('HCM/UV');
    var dbRef4 = firebase.database().ref().child('HCM/CO2');
    var dbRef5 = firebase.database().ref().child('HCM/NOISE');
    var dbRef6 = firebase.database().ref().child('HCM/GIO');
    ...
    var dbRef = firebase.database().ref().child('HANOI/TEMP');
    var dbRef2= firebase.database().ref().child('HANOI/HUMI');
    var dbRef3 = firebase.database().ref().child('HANOI/UV');
    var dbRef4 = firebase.database().ref().child('HANOI/CO2');
    var dbRef5 = firebase.database().ref().child('HANOI/NOISE');
    var dbRef6 = firebase.database().ref().child('HANOI/GIO');
    ...
    dbRef4.on('value', snap => nongdoco2.innerText = snap.val()+" CO2");
